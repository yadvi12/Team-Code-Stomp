...
def api_otp_gen():
    ...
    request_path = "/API/V1/23c1d13c-2bf0-11eb-83d4-0200cd936042/SMS/"+phone+"/AUTOGEN"
...
def api_otp_verify():
    ...
    payload = ""
    headers = { 'content-type': "application/x-www-form-urlencoded" }
    request_path = "/API/V1/23c1d13c-2bf0-11eb-83d4-0200cd936042/SMS/VERIFY/"+session_id+"/"+otp
    http_conn.request("GET", request_path, payload, headers)
    res = http_conn.getresponse()
    data = res.read()
    json_data = json.loads(data.decode('utf-8'))
